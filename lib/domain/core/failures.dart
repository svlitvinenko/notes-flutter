...
abstract class ValueFailure<T> with _$ValueFailure<T> {
  ...
  const factory ValueFailure.exceedingLength({@required T failedValue, @required int maxPermitted}) = ExceedingLength<T>;
  ...
  const factory ValueFailure.listTooLong({@required T failedValue, @required int maxPermitted}) = ListTooLong<T>;
}
